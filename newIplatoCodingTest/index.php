<?php
namespace newIplatoCodingTest;

use newIplatoCodingTest\Engine as E;
...
try
{
    ...
    $aParams = ['ctrl' => (!empty($_GET['p']) ? $_GET['p'] : 'BlogController'), 'act' => (!empty($_GET['a']) ? $_GET['a'] : 'index')]; // I use the new PHP 5.4 short array syntax
